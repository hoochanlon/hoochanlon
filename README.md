...
书签及各类表单与Apple Music直达，开箱即用的GitHub个人资料主页。 
...
|  快捷表   |          <a href="https://github.com/hoochanlon/tetyou/blob/master/CHEATSHEET.md" target="_blank" >Shell小抄</a> <a href="https://www.explainshell.com">Shell语法分析</a>                                                    |
| :-----------: | :----------------------------------------------------------: |
